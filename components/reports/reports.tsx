    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Generate and view reports on visitor data and access control.
        </p>
      </div>
        ...
        <Card className="bg-destructive/10 border-destructive/20">
          <CardContent className="p-3">
            <p className="text-sm text-destructive">
              Error loading reports data. Please try refreshing.
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <Tabs
        ...
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-4">
          <TabsTrigger value="visitor-management">
            Visitor Management
          </TabsTrigger>
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <SecurityIncidentsChart
                    data={accessStats?.securityIncidents}
                  />
                )}
              </CardContent>
            </Card>
        ...
        <TabsContent
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create and save custom reports with the metrics that matter to
                you.
              </CardDescription>
            </CardHeader>
            <CardContent className="h-[400px] flex items-center justify-center">
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground max-w-md">
                  Select metrics, time ranges, and visualization types to build
